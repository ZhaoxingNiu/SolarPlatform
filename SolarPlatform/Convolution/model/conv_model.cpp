...
//		int grid_index = 0;
//		// run the model 
//		conv_method_kernel_focus(solar_scene, rece_index, helio_index, 28,grid_index, make_float3(0.0f, 0.0f, 0.0f), kernelType::T_LOADED_CONV, 0.0f);
//
//		// *********修改******* /
//		string file_outputname = "../SimulResult/paper/scene_ps10_flat/model/equinox_12_#" + std::to_string(helio_index) + ".txt";
//		solar_scene->receivers[rece_index]->save_result_conv(file_outputname);
//		if (helio_index == 0) {
//			first_times = solarenergy::total_time;
//		}
