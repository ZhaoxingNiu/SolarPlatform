...
#    receiver3 = np.r_[receiver3[0:10],receiver3[0:230]]
    
#    receiver0 = np.r_[receiver0[6:240],receiver0[234:240]]
#    receiver3 = np.r_[receiver3[6:240],receiver3[234:240]]
    
    
    sum_val = (receiver0.sum() + receiver1.sum() + receiver2.sum() + receiver3.sum())/400
    peak_val = max(receiver0.max(),receiver1.max(),receiver2.max(),receiver3.max())
